...
myChart2:any;
  ...
  this.orderService.CountingOrderByDate(this.from.value,this.to.value).subscribe((res: any)=>{console.log(res)
...
this.paymentService.SumPaymentGroupByDate(this.from.value,this.to.value).
subscribe(res=>{
  let dataArray:number[]=[];
  let labelArray:string[]=[];
  res.forEach((element:any) => {
